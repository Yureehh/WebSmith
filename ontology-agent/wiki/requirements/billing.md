---
id: entity_23af51802d36cb6f
type: Requirement
project: ontology-agent
graph_node_id: entity_23af51802d36cb6f
sources:
...
Billing is tracked as a Requirement in the project graph. It has 0 outgoing and 2 incoming validated relationships.
...
- [[websmith|WebSmith]] -> `blocks` (confidence 0.90, validated)
- [[websmith|WebSmith]] -> `blocks` (confidence 0.95, validated)
