---
id: entity_b728d4e25bfdf015
type: Task
project: ontology-agent
graph_node_id: entity_b728d4e25bfdf015
sources:
...
Lint command is tracked as a Task in the project graph. It has 0 outgoing and 0 incoming validated relationships.
