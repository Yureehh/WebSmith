---
id: entity_f4829f8263eec371
type: Task
project: ontology-agent
graph_node_id: entity_f4829f8263eec371
sources:
...
Test command is tracked as a Task in the project graph. It has 0 outgoing and 0 incoming validated relationships.
