---
id: entity_e53596e48e9fdd93
type: Task
project: ontology-agent
graph_node_id: entity_e53596e48e9fdd93
sources:
- span_63ffe0bbb61cea27
---

# Task: Import final site

## Summary

Import final site is tracked as a Task in the project graph. It has 1 outgoing and 0 incoming validated relationships.
...
- `writes_to` -> [[websmith|WebSmith]] (confidence 0.96, validated)
