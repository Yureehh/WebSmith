---
id: entity_8b599b036397a3ff
type: Concept
project: ontology-agent
graph_node_id: entity_8b599b036397a3ff
sources:
- span_63ffe0bbb61cea27
---

# Concept: Provider warnings

## Summary

Provider warnings is tracked as a Concept in the project graph. It has 0 outgoing and 1 incoming validated relationships.
...
- [[daily-flow|Daily Flow]] -> `validates` (confidence 0.90, validated)
