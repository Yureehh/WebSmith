---
id: entity_adf2070aecb3d87b
type: Concept
project: ontology-agent
graph_node_id: entity_adf2070aecb3d87b
sources:
...
mobile is tracked as a Concept in the project graph. It has 0 outgoing and 1 incoming validated relationships.
...
- [[qa-review|QA review]] -> `validates` (confidence 0.90, validated)
