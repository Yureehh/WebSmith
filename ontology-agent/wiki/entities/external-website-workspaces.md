---
id: entity_4b8ed715514a29a1
type: Concept
project: ontology-agent
graph_node_id: entity_4b8ed715514a29a1
sources:
- span_64c2cfa728545a2d
---

# Concept: external website workspaces

## Summary

external website workspaces is tracked as a Concept in the project graph. It has 0 outgoing and 1 incoming validated relationships.
...
- [[websmith|WebSmith]] -> `generates` (confidence 0.95, validated)
