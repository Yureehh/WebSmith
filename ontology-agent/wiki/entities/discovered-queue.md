---
id: entity_18a092db88107b8f
type: Concept
project: ontology-agent
graph_node_id: entity_18a092db88107b8f
sources:
- span_64c2cfa728545a2d
---

# Concept: discovered queue

## Summary

discovered queue is tracked as a Concept in the project graph. It has 0 outgoing and 1 incoming validated relationships.
...
- [[lead-storage|lead storage]] -> `contains` (confidence 0.95, validated)
