---
id: entity_315b32b3129f7e20
type: Concept
project: ontology-agent
graph_node_id: entity_315b32b3129f7e20
sources:
- span_64c2cfa728545a2d
- span_80648b96719fbc77
---

# Concept: Search depth

## Summary

Search depth is tracked as a Concept in the project graph. It has 0 outgoing and 2 incoming validated relationships.
...
- [[searches|Searches]] -> `supports` (confidence 0.99, validated)
- [[osm-overpass-discovery|OSM/Overpass discovery]] -> `uses` (confidence 0.95, validated)
