---
id: entity_e46c97f94edf0487
type: Concept
project: ontology-agent
graph_node_id: entity_e46c97f94edf0487
sources:
...
zip path is tracked as a Concept in the project graph. It has 0 outgoing and 1 incoming validated relationships.
...
- [[websmith|WebSmith]] -> `reads_from` (confidence 0.84, validated)
