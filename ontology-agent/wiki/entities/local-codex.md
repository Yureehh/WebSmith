---
id: entity_0083fd1265404f31
type: Technology
project: ontology-agent
graph_node_id: entity_0083fd1265404f31
sources:
- span_63ffe0bbb61cea27
- span_64c2cfa728545a2d
---

# Technology: local Codex

## Summary

local Codex is tracked as a Technology in the project graph. It has 0 outgoing and 2 incoming validated relationships.
...
- [[external-builders|External builders]] -> `contains` (confidence 0.98, validated)
- [[build-brief-md|BUILD_BRIEF.md]] -> `supports` (confidence 0.90, validated)
