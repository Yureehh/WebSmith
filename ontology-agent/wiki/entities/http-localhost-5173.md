---
id: entity_552814872ab4ef01
type: Technology
project: ontology-agent
graph_node_id: entity_552814872ab4ef01
sources:
- span_80648b96719fbc77
---

# Technology: http://localhost:5173

## Summary

http://localhost:5173 is tracked as a Technology in the project graph. It has 0 outgoing and 1 incoming validated relationships.
...
- [[frontend|Frontend]] -> `runs_on` (confidence 0.99, validated)
