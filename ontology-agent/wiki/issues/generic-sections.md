---
id: entity_87a565dbb6d1bfbb
type: Issue
project: ontology-agent
graph_node_id: entity_87a565dbb6d1bfbb
sources:
- span_2ef30ca0ceafa9e5
---

# Issue: generic sections

## Summary

generic sections is tracked as a Issue in the project graph. It has 0 outgoing and 1 incoming validated relationships.
...
- [[qa-review|QA review]] -> `blocks` (confidence 0.82, validated)
